...
namespace Assignment
{
    internal class member
    {
        ...
        public member() { }
        public member(string mbn, string em, string ctn, string tl, string rl)
        {
            membername = mbn;
            email = em;
            contactnumber = ctn;
        ...
        public member(string mbn, string em, string ctn, SqlMoney salary)
        {
            membername = mbn;
            email = em;
            contactnumber = ctn;
        ...
        public member(string mbn2)
        {
            membername = mbn2;
        }

        public member(string membername, string email, string contactnumber, SqlMoney salary, string role)
        {
        ...
        public member(string membername, string email, string contactnumber, SqlMoney salary, string level, string role)
        {
            this.membername = membername;
            this.email = email;
            this.contactnumber = contactnumber;
